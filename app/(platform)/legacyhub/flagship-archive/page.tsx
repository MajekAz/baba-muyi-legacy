...
const title = "Baba Muyi Legacy - The First LegacyHub Flagship Archive";
const description = "Baba Muyi Legacy is the first flagship archive powered by LegacyHub.";
...
export default function FlagshipArchivePage() {
  return (
    <main className="bg-[#f8f3e8] text-slate-950">
      ...
      <PlatformPageHero eyebrow="The first LegacyHub flagship archive" title="Baba Muyi Legacy">
        <p>Baba Muyi Legacy preserves material connected to Alhaji Tioluwalase &quot;Baba Muyi&quot; Majekodunmi.</p>
      </PlatformPageHero>
      <PlatformSection title="A real archive demonstrating a reusable platform.">
        <p className="max-w-3xl text-lg leading-8 text-slate-700">
          The archive brings together life story material, transport heritage, family history, public memories, values, documentary material, and approved media. It remains a Baba Muyi-focused archive, while LegacyHub provides the platform architecture behind it.
        </p>
      ...
      <PlatformSection dark title="Explore the flagship archive">
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <ArchiveLink href="/" label="View the archive" />
          <ArchiveLink href="/biography" label="Read the biography" />
