...
const description = "Contact LegacyHub about early access, platform enquiries, or the Tioluwalase Majekodunmi flagship archive.";
  ...
  return (
    <main className="bg-[#f8f3e8] text-slate-950">
      ...
      <PlatformPageHero eyebrow="Contact" title="Contact LegacyHub">
        <p>Use the supported project routes below to express interest, ask a platform question, or return to the Tioluwalase Majekodunmi flagship archive.</p>
      </PlatformPageHero>
      <PlatformSection title="Enquiry routes">
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <article className="rounded border border-stone-300 bg-white p-6">
            <h2 className="font-serif text-2xl font-semibold">Tioluwalase Majekodunmi</h2>
            <p className="mt-3 leading-7 text-slate-700">Visit the flagship archive to explore the current public implementation.</p>
            <Link className="mt-5 inline-block text-sm font-black text-amber-800 hover:text-slate-950" href="/">View Tioluwalase Majekodunmi</Link>
          </article>
          <article className="rounded border border-stone-300 bg-white p-6">
