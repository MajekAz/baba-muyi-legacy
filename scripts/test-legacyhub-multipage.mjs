...
assert(read("app/(platform)/legacyhub/about/page.tsx").includes("Why LegacyHub was created") && read("app/(platform)/legacyhub/about/page.tsx").includes("Baba Muyi Legacy inspired the platform"), "about full content", "About page keeps platform/founder-context content.");
