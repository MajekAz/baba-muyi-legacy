...
assert(mediaQueries.includes("isKnownUnverifiedBabaMuyiPublicMedia") && mediaQueries.includes('title === "my pix"') && mediaQueries.includes('altText === "my pix archive image"'), "my pix filter", "Known unverified My Pix media is excluded from public media rendering before signed URLs are created.");
